...
- Once the scan finishes, navigate to the **Dashboard** — your latest scan results will be displayed there automatically.
- Click **View Full Report** on the Dashboard and wait **3–4 seconds** for the full incident report to load.
- Then navigate to **Incident Reports** in the sidebar to find your report listed.
- From the Incident Reports page, you can **Download as Text** or **Download as JSON** for offline review or submission.
